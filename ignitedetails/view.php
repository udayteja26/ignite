...
<head>
    ...
    <title>Ignite User Details</title>
...
<body>
 ...
 <form action="tech.php" method="post">
    <div ng-app="myApp" ng-controller="controller">
        <div class="container">
            <br/>
            <h3 align="center">Ignite User Details</a></h3>
            <br/>
            <div class="row">
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            <tr ng-repeat="data in searched = (file | filter:search | orderBy : base :reverse) | beginning_data:(current_grid-1)*data_limit | limitTo:data_limit">
								...
								<?php echo "<td><a target='_blank' href=\"ignitedetailsentryform.php?sno={{data.sno}}\">Edit</a>  </td> "?>
                            </tr>
                        </tbody>
                    </table>
                </div>
